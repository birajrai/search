...
async function request(query) {
    ...
    const summaryJson = await (0, parser_1.requestJSON)("https://en.wikipedia.org/w/api.php?format=json&action=query&prop=extracts|pageimages&exintro&explaintext&redirects=1&exsentences=2&titles=" +
