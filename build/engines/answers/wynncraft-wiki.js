...
async function request(query) {
    ...
    const summaryJson = await (0, parser_1.requestJSON)("https://wynncraft.gamepedia.com/api.php?format=json&action=query&prop=extracts&exintro&explaintext&redirects=1&titles=" +
